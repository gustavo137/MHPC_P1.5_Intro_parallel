#!/bin/bash
#SBATCH --job-name=25_mpi_blas_cannon    ## Job name
#SBATCH --output=25N.datg
#SBATCH -N 1 # Number of nodes
#SBATCH --ntasks-per-node=25                  ## Run on a single CPU
#SBATCH --cpus-per-task=1
#SBATCH --time=00:05:00               ## Time limit hrs:min:sec
#SBATCH -A ICT24_MHPC
#SBATCH -p boost_usr_prod

echo "Running cannon N25"
