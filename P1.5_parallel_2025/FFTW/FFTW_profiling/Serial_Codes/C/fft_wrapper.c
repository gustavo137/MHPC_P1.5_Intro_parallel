...
void init_fftw(fftw_handler *fft, int n1, int n2, int n3) {
   ...
   */
  fft->fftw_data =
      (fftw_complex *)fftw_malloc(n1 * n2 * n3 * sizeof(fftw_complex));
   ...
   *
   */
  fft->fw_plan = fftw_plan_dft_3d(n1, n2, n3, fft->fftw_data, fft->fftw_data,
                                  FFTW_FORWARD, FFTW_ESTIMATE);
  fft->bw_plan = fftw_plan_dft_3d(n1, n2, n3, fft->fftw_data, fft->fftw_data,
...
void fft_3d(fftw_handler *fft, int n1, int n2, int n3, double *data_direct,
